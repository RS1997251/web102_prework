...
let unfundedMessage;
if (numUnfunded === 1) {
    unfundedMessage = `Currently, 1 game remains unfunded.`;
} else {
    unfundedMessage = `Currently, ${numUnfunded} games remain unfunded.`;
}

const descriptionString = `
    A total of $${totalRaised.toLocaleString()} has been raised for ${numGames} games. 
    ${unfundedMessage} We need your help to fund these amazing games!
`;
